...
class Exponential:
    ...
    def __init__(self,base,powerExp):
        self.base=base
        self.tenExp=powerExp

    @property
    def real(self):
        return self.base*pow(10,self.tenExp)
...
# def add_Exponential_and_ration(e,r):
#     if e.bace <0:
#     return Rational((1*r.denom+ r.number* e.real),r.denom*)
...
add.implementations[('exp', 'rat')]= add_Exponential_and_ration

def apply(mes,func1,func2):
    kind=(type_tag(func1),type_tag(func2))
    keys =(mes,kind)
    return apply.implementations[keys](func1, func2)
...
#apply.implementations[('add',('exp', 'rat'))]= add_rational
